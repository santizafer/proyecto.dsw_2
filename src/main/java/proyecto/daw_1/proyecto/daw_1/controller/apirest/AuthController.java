...
import proyecto.daw_1.proyecto.daw_1.model.response.UsuarioResponse;
import proyecto.daw_1.proyecto.daw_1.service.DetalleUsuarioService;
...
public class AuthController {
    ...
    private String generarToken(Usuario usuario){
        ...
        String token =
                Jwts.builder()
                        .setId(usuario.getCodusuario().toString())
